        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div>
                <label htmlFor="prep_time_category" className="block text-sm font-medium text-gray-700 mb-2">
                  Time Category
                </label>
                <select
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              {errors.ingredients?.[0]?.name && (
                <p className="mt-1 text-sm text-red-600">{errors.ingredients[0].name.message}</p>
              )}
            </div>
